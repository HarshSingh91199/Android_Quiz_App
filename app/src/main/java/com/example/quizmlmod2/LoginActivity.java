...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTheme(R.style.Theme_QuizMLMod2);
        ...
        tvSignUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(com.example.quizmlmod2.LoginActivity.this,RegisterActivity.class));
            }
        });
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            for (User user : users){
                if (username.equals(user.getUsername()) && password.equals(user.getPassword())){
                    SharedPref sharedPref = SharedPref.getInstance();
                    sharedPref.setUser(com.example.quizmlmod2.LoginActivity.this,user);
                    startActivity(new Intent(com.example.quizmlmod2.LoginActivity.this,MainActivity.class));
                    return;
                }
            }
            Toast.makeText(com.example.quizmlmod2.LoginActivity.this, "User not exist", Toast.LENGTH_SHORT).show();
