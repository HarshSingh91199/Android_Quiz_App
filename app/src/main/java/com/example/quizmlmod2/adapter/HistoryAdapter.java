package com.example.quizmlmod2.adapter;
...
import com.example.quizmlmod2.data.Attempt;

import java.util.List;

import static com.example.quizmlmod2.other.Utils.formatDate;

public class HistoryAdapter extends RecyclerView.Adapter<com.example.quizmlmod2.adapter.HistoryAdapter.AttemptViewHolder> {
    ...
    public AttemptViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new com.example.quizmlmod2.adapter.HistoryAdapter.AttemptViewHolder(view);
    }
